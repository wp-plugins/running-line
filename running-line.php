...
Description: This plugin shows running line for a post of a chosen category. <a href="options-general.php?page=running-line.php">Settings</a>
Version: 1.0
...
function set_default_running_line_settings(){
    ...
    $running_line_settings = array($running_line_plugin_prefix."category"=>$running_line_category,$running_line_plugin_prefix."order"=>$running_line_order,$running_line_plugin_prefix."direction"=>$running_line_direction,$running_line_plugin_prefix."scrolldelay"=>$running_line_scrolldelay,$running_line_plugin_prefix."width"=>$running_line_width,$running_line_plugin_prefix."height"=>$running_line_height,$running_line_plugin_prefix."font_size"=>$running_line_font_size,$running_line_plugin_prefix."color"=>$running_line_color,$running_line_plugin_prefix."border_size"=>$running_line_border_size,$running_line_plugin_prefix."border_color"=>$running_line_border_color,$running_line_plugin_prefix."background"=>$running_line_background,$running_line_plugin_prefix."padding"=>$running_line_padding);
...
function running_line_style(){
    global $running_line_plugin_url, $running_line_plugin_prefix;

    $running_line_settings = get_running_line_settings();
?>
    <link rel="stylesheet" href="<?php echo($running_line_plugin_url); ?>css/running-line-style.css" type="text/css" />
    <!--[if IE 6]>
        <link rel="stylesheet" href="<?php echo($running_line_plugin_url); ?>css/running-line-iestyle.css" type="text/css" />
    <![endif]-->
    ...
    #running_line{
      ...
      border: <?php echo($running_line_settings[$running_line_plugin_prefix."border_size"]); ?> solid <?php echo($running_line_settings[$running_line_plugin_prefix."border_color"]); ?>;
    }
